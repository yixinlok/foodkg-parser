...
for i in range(0, len(nutri_info)):
    id_to_recipe[nutri_info[i]["id"]].fsa_lights_per100g = nutri_info[i]["fsa_lights_per100g"]
    id_to_recipe[nutri_info[i]["id"]].nutr_values_per100g = nutri_info[i]["nutr_values_per100g"]
